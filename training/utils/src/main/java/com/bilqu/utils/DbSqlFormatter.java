...
public class DbSqlFormatter {
	...
	public static void main(String[] arg){
		String input = "select NAME,AGE,HISTORY_CD,STATUS,REPORT_DT from CRIME_DATA where REPORT_DT  = '2018-03-16';                                                                                                                                                                                                                      ';";
		String formattedSQL =  new FormatProcess( input ).perform();
